...
/// Rewrite of the default [FlushbarHelper] class
/// with my own customizations
extension FlushbarHelpers on Flushbar {
  ...
  static Flushbar createSuccess({
    ...
    return Flushbar(
      ...
      leftBarIndicatorColor: BrandColors.success,
      duration: duration,
  ...
  static Flushbar createError({
    ...
    return Flushbar(
      ...
      leftBarIndicatorColor: BrandColors.error,
      duration: duration,
      shouldIconPulse: false,
    );
  }
